              ...
              <div className="flex-1 flex flex-col gap-8 justify-center">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Personalized services tailored to meet every client’s
                      unique needs.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Making psychological services affordable and accessible
                      for everyone.
                    </p>
                  </div>
                </div>
          ...
          <div className="mt-40 bg-red-500 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-12">
              ...
              <div className="p-8 rounded flex flex-col items-center text-center text-sm text-slate-500 shadow-card2 transition-all hover:shadow-card duration-500">
                ...
                <p className="text-xs italic">
                  Supporting Young Minds with Care
                </p>
                <p className="mt-6">
              ...
              <div className="p-8 rounded flex flex-col items-center text-center text-sm text-slate-500 shadow-card2 transition-all hover:shadow-card duration-500">
                ...
                <p className="mt-6">
                  Prepare for PRC Board Examinations with expert-led tutorials
                  in psychology, psychometrics, and education.
                </p>
              </div>
